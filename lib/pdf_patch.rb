...
module PDFPatch
  ...
  module InstanceMethods
    ...
    def issue_to_pdf_with_patch(issue, assoc={})
      ...
      right << [l(:field_estimated_hours), l_hours(issue.estimated_hours)] unless issue.disabled_core_fields.include?('estimated_hours') || User.current.deny_view_estimated_time?(issue.project)
